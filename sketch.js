...
function preload(){
  ...
  knifeTouchingFruitGroup = loadSound("knifeSwoosh.mp3");
  knifeTouchingMonsterGroup = loadSound("gameover.mp3");
...
function draw() {
  ...
  if(gameState===PLAY){
   ...
   // monsterGroup.velocityX = -(7+3*score/8);
    //fruitGroup.velocityX = -(7+3*score/8);
    ...
    else
    {
      ...
      if(monsterGroup.isTouching(knife)){
       ...
       knifeTouchingMonsterGroup.play();
